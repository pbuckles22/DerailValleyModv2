...
- [~] **Epic 6** Diagnostic HUD — **6.1–6.10** `[x]`; **6.14** cut; **6.19** consist stress backlog

### In flight

- Epic **6** remainder (**6.11** Marked, **6.13** Job). Station → **6.12**. Dual junction **numbers** still through-only (`selectedBranch` already chooses the thrown track). Look-around hitch is TECH_DEBT. Glide + pause-hide are Later.

### Sequence (do not pause to pick)

Next in [PM_PLAN.md](PM_PLAN.md): **6.11** Marked, then remaining Epic **6** waves (**6.19** consist stress after **6.18**), then **4.4** PID when spec lands. Epic 5 after engines.
