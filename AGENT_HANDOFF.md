...
- Epic **6** remainder (**6.17–6.21**). Dual junction **numbers** still through-only. Look-around hitch is TECH_DEBT (H67/H72). Cab overlay-retry hitch **closed** (H107). PNG icons → **6.17**. Auto-coupler still **5.4**. Glide + pause-hide are Later.
