...
- **`T2 look-at bar` log volume** — Repeats while aiming (3.3.1 + 6.3 smokes). Product labels are stable; throttle or log-on-change in **6.2**. Not a hitch by itself; it is log tax.
