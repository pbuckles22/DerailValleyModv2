...
| **EPIC** | Epic number in PM_PLAN | Working in Epic 1 → `2.1.x`. Epic 3 → `2.3.x`. After HUD (**6**), leftover work is **7+** (speed **9**, multi-job Maps **10**, catalog **11**, roadside **12**, autonomy **13**, Maps desk **14**) so UMM never goes backwards from `2.6.21`. |
