...
| **`feature/13.2.4.5-yard-taper`** | WIP — kiss **`2.13.2.4.10`**; CLEARED PASS; Prep leftover ~2 m is pin-band, not a second process. Do not merge. |
...
**Next:** Land Prep kiss on the knuckle (**4.11**). Then **13.2.5/6** + **13.3** when asked. TT mid stays special-case. Do not pop 13.2.5 stash.
