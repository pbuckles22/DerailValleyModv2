...
**DerailValleyModv2** — Yard Master Suite v2. **Epic 3 Display Shell (infra) closed** at **3.3.1**. **Epic 4 infra closed** at **4.3**. **Epic 6 Diagnostic HUD closed** at **6.21** (`2.6.21.6`) on **`main`**. Leftover work is numbered **7+** so UMM does not go backwards from **2.6.21**. Next: **7.1** Three-Gate when asked. Full v1 map: [V1_FEATURE_COVERAGE.md](V1_FEATURE_COVERAGE.md).
...
| Branch | Role |
|--------|------|
| **`main`** | Integration — **Epic 6** closed (`2.6.21.6` job-car AR). |

---

## Sequence

**Next:** **7.1** Three-Gate when asked. Dual junction **numbers** stay through-only. **10.1** PID blocked on user spec. Auto-coupler is **7.4**.
...
- [ ] **Epic 7** — Governors (Three-Gate / thermal / auto-brake / coupler / Limit throttle)
