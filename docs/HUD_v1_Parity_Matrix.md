...
| Clock (in-game) | 1.12 | **6.1** | `ClockDisplay` | `AlwaysOnHudListener` (API TBD) | `ClockDisplay` (v1) | world time | `[ ]` |
...
| Sticky Y from HUD stack | `LastStackBottomGuiY` | `HudStackLayout.LastBottomGuiY` | **6.4** | `[~]` |
