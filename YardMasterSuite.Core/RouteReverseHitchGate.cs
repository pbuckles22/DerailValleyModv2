...
/// Ctrl+Right. Standstill Set dest stays AtSwitch and must not close the desk
/// (smoke 2.8.7.28). Ctrl+Right overrides hitch-hide (cab 2.13.2.5.1).
...
public static class RouteReverseHitchGate
{
    ...
    /// <summary>
    /// Auto-close while reversing to the pin. Right-arrow override keeps the desk
    ...
    /// <summary>
    /// Ctrl+Right always toggles. Cab 2.13.2.5.1 hitch-hold blocked GO.
    /// </summary>
