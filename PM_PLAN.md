...
**Version:** `info.json` is `2.{Epic}.{Story}` for the last **[x]** story (story **6.6** → **2.6.6**). See [docs/Versioning_and_Release_Strategy.md](docs/Versioning_and_Release_Strategy.md).
